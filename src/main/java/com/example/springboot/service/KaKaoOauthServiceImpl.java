...
public class KaKaoOauthServiceImpl implements KakaoOauthService {
    ...
    public LoginResponseDTO processKakaoLogin(String code, HttpServletResponse response, HttpServletRequest request) {
        ...
        if (memberInfo != null) {
            ...
            if (existingMember != null) {
                ...
                if (decryptedPhoneLast.equals(phoneLast)) {
                    if (CommonCodeEnum.KAKAO.getValue().equals(existingMember.getSnsType())) {
                        //기존회원
                        memberId = existingMember.getMemberId();
                        isExistingMember = true;
                    } else if (CommonCodeEnum.NAVER.getValue().equals(existingMember.getSnsType())) {
                        System.out.println("네이버 계정 있움");
                        throw new SocialOauthException(ExceptionCodeEnum.NAVER_ACCOUNT_ALREADY_EXISTS.getMessage());
                    } else {
            ...
            if (!isExistingMember) {
                ...
                socialMemberDTO.setSns(CommonCodeEnum.KAKAO.getValue());
        ...
        throw new SocialOauthException(ExceptionCodeEnum.KAKAO_LOGIN_FAIL.getMessage());
    }
