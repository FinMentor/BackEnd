...
- **공통 사항**
  - 배포전 프로젝트 자동정렬 및 import 필수!!!(IntelliJ)
    ...
    - import
      ...
      - Window : Ctrl + Alt + O
  - 데이터베이스 개발 가이드
    - 링크 : https://bjhbhm.atlassian.net/wiki/spaces/S5BYxz0B9CKL/pages/18252169
...
- **백엔드 개발 가이드**
  - 링크 : https://bjhbhm.atlassian.net/wiki/spaces/S5BYxz0B9CKL/pages/18252127
